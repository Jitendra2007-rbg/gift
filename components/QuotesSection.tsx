...
const QuoteCard: React.FC<{ quote: typeof CONTENT.quotes[0]; index: number }> = ({ quote, index }) => {
  ...
  return (
    <div 
      ref={elementRef}
      className={`relative p-8 md:p-12 bg-white/40 backdrop-blur-sm rounded-3xl border border-white/50 shadow-lg transform transition-all duration-1000 ease-out ${
    ...
    >
      ...
      <div className="relative z-10 text-center">
        ...
        {quote.author && (
          <p className="font-sans text-sm uppercase tracking-widest text-romantic-500 font-semibold">
            — {quote.author}
          </p>
        )}
      </div>
